    ...
    var body: some View {
        VStack {
            CheckoutCardView(description: "Root Checkout Screen", buttonImage: Image(systemName: "arrow.forward.circle"), color: .blue) {
                router.pushTo(view: CheckoutView.builder.makeView(CheckoutView2(), withNavigationTitle: "Checkout 2"))
            }
        }
    ...
    var body: some View {
        VStack {
            CheckoutCardView(description: "Checkout Screen 2", buttonImage: Image(systemName: "arrow.forward.circle"), color: .green) {
                router.pushTo(view: CheckoutView.builder.makeView(CheckoutView3(), withNavigationTitle: "Checkout 3"))
            }
    ...
    var body: some View {
        VStack {
            CheckoutCardView(description: "Checkout Screen 3", buttonImage: Image(systemName: "arrow.forward.circle"), color: .red) {
                router.pushTo(view: CheckoutView.builder.makeView(CheckoutView4(), withNavigationTitle: "Checkout 4"))
            }
